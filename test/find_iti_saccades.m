...
for session_i = 1:29
    ...
    for ch_index = 2:3
        ...
        EEG_target_left{ch_index}(session_i,:) = nanmean( EEG_signal.np_saccade{session_i,ch_index}(ttx_iti_saccade.left{session_i},:));
        EEG_target_right{ch_index}(session_i,:) = nanmean( EEG_signal.np_saccade{session_i,ch_index}(ttx_iti_saccade.right{session_i},:));

        EEG_saccade_left{ch_index}(session_i,:) = nanmean( EEG_signal.np_saccade{session_i,ch_index}(ttx_iti_saccade.left{session_i},:));
        EEG_saccade_right{ch_index}(session_i,:) = nanmean( EEG_signal.np_saccade{session_i,ch_index}(ttx_iti_saccade.right{session_i},:));
...
for session_i = 1:29
    plot_EEG_left_A(session_i,:)  = EEG_saccade_left{2}(session_i,:);
    plot_EEG_right_A(session_i,:) = EEG_saccade_right{2}(session_i,:);

    plot_EEG_left_B(session_i,:)  = EEG_saccade_left{3}(session_i,:);
    plot_EEG_right_B(session_i,:) = EEG_saccade_right{3}(session_i,:);
