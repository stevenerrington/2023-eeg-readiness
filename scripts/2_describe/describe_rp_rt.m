...
anova_table = table(average_erp_target_AD02(1:29), average_erp_target_AD02(30:end),...
    average_erp_saccade_AD02(1:29), average_erp_saccade_AD02(30:end),...
    average_erp_target_AD03(1:29), average_erp_target_AD03(30:end),...
    average_erp_saccade_AD03(1:29), average_erp_saccade_AD03(30:end),...
    'VariableNames',{'F3_target_fast','F3_target_slow',...
    'F3_saccade_fast','F3_saccade_slow',...
    'F4_target_fast','F4_target_slow',...
    'F4_saccade_fast','F4_saccade_slow'});

writetable(anova_table,fullfile(dirs.root,'results','eeg_uv_fastslow_rt.csv'),'WriteRowNames',true)
